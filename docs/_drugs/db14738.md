...
| 13 | platelet-type bleeding disorder | KG + DL |
...
| 17 | hemophilia A with vascular abnormality | KG + DL |
| 18 | hemorrhagic disorder due to a platelet anomaly | KG + DL |
| 19 | factor XIII, A subunit, deficiency | KG + DL |
| 20 | congenital factor V deficiency | KG + DL |
| 21 | factor XI deficiency | KG + DL |
