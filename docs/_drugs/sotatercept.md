...
Sotatercept is an activin receptor IIA-Fc fusion protein whose established approved indication is pulmonary arterial hypertension (PAH), as noted in the evidence pack's own mechanistic notes.
The TxGNN model predicts it may be effective for **Acute Lymphoblastic Leukemia**,
but **0 clinical trials** and **0 publications** currently support this direction — the prediction rests on model score alone.
