...
Denne side kombinerer de AI-forudsagte indikationer for Gemfibrozil med de seneste sundhedsnyheder. Indikationer markeret med orange har været omtalt i nyhederne for nylig.
</div>
...
<p><a href="{{ '/drugs/gemfibrozil/' | relative_url }}">Se den fulde lægemiddelrapport →</a></p>
</div>
