#!/usr/bin/env python3
"""Run Knowledge Graph predictions - Denmark version
...
Prerequisites:
    1. Downloaded Danish data (data/raw/danish_medicines.xlsx)
...
from dktxgnn.data.loader import load_fda_drugs, filter_active_drugs, get_drug_summary
from dktxgnn.mapping.drugbank_mapper import map_fda_drugs_to_drugbank
from dktxgnn.predict.repurposing import load_drug_disease_relations


def main():
    print("=" * 60)
    print("DkTxGNN - Knowledge Graph Prediction")
    print("=" * 60)
    print()
    ...
    # 1. Load drug data
    print("1. Loading Denmark drug data...")
    ...
    print()
    print("Summary:")
    print(f"  - DK registered medicines: {summary['total_count']}")
    ...
    print("  PYTHONPATH=src python -m dktxgnn.predict.txgnn_model")
