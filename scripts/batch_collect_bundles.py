...
import pandas as pd
from dktxgnn.collectors import DrugBundleAggregator
from dktxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from dktxgnn.collectors.drug_bundle import PredictedIndication
    from dktxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from dktxgnn.collectors.drug_bundle import DrugBundle
